...
M.set = function()
    ...
    hl('@function.macro', { fg = colors.yellow_6, bold = true })
    hl('@attribute', { fg = colors.orange_4 })
		hl('@attribute.type', { bold = true })
    ...
    hl('@type.qualifier', { fg = colors.teal_5 })
    hl('@type.definition', { fg = colors.black_3 })
    ...
    hl('NeogitDiffDeleteCursor', { fg = colors.red_1, bg = colors.light_4 })
		...
		hl('@parameter.property.ocaml', { link = 'Identifier' })
    ...
    hl('@punctuation.parameter.property.ocaml', { fg = colors.orange_5 })
		...
		hl('@punctuation.other.ocaml_interface', { fg = colors.orange_5, bold = false })
		hl('@parameter.property.ocaml_interface', { link = 'Identifier' })
		hl('@tag.ocaml_interface', { fg = colors.black_3 })
		hl('@tag.delimiter.ocaml_interface', { fg = colors.black_3 })
		hl('@operator.ocaml_interface', { fg = colors.black_3 })
    hl('@constructor.ocaml_interface', { fg = colors.violet_4 })
    hl('@punctuation.parameter.property.ocaml_interface', { fg = colors.orange_5 })
		...
		hl('@punctuation.other.reason', { fg = colors.orange_5, bold = false })
		hl('@parameter.property.reason', { link = 'Identifier' })
		hl('@tag.reason', { fg = colors.black_3 })
		hl('@tag.attribute.reason', { fg = colors.black_3 })
		hl('@tag.builtin.reason', { fg = colors.black_3 })
		hl('@tag.delimiter.reason', { fg = colors.blue_4, bold = true })
    ...
    hl('@function.latex', { link = 'Keyword' })
		...
		hl('@punctuation.parameter.property.python', { fg = colors.orange_5 })
